...
export HARBOR_HOST="192.168.2.101"
export HARBOR_PORT="5443"

# 生成ca证书私钥
cd $HARBOR_HOME/ssl || exit
...
# Locality Name : BJ
# commonName = 192.168.2.101

# 签发证书
openssl x509 -req -in harbor.csr -CA ca.pem -CAkey ca.key -CAcreateserial -out harbor.pem -days 3650

#sudo mkdir -p /etc/docker/certs.d/$HARBOR_HOST:$HARBOR_PORT
#sudo cp /home/harbor/harbor.crt /etc/docker/certs.d/$HARBOR_HOST:$HARBOR_PORT/ca.crt
cd $HARBOR_HOME || exit
